...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    user: "livanshu0178@gmail.com",
    pass: "", // password type karna hai yaha- app password -- git pr upload krne k liye hataya hai 
  },
});
...
module.exports.sendOTP=async function sendOTP(user,otp) {
  ...
  const info = await transporter.sendMail({
    from: '"Password Manager" <livanshu0178@gmail.com>', // sender address
